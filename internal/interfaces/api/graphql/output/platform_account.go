	...
	return graphql.NewObject(graphql.ObjectConfig{
		...
		Fields: graphql.Fields{
			...
			"role": &graphql.Field{
				Type: types["role"],
				Resolve: func(params graphql.ResolveParams) (interface{}, error) {
					return authUsecase.GetRoleByIDWithPermissions(params.Context, params.Source.(entity.PlatformAccount).RoleID)
				},
			},
			"department": &graphql.Field{
				Type: types["department"],
				Resolve: func(params graphql.ResolveParams) (interface{}, error) {
					return platformUsecase.GetDepartmentByID(params.Context, params.Source.(entity.PlatformAccount).DepartmentID)
				},
			},
		},
	})
