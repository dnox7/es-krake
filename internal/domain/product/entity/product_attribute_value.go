...
type ProductAttributeValue struct {
	ID          int           `json:"id" db:"id"`                     // Unique identifier for the product attribute value
	...
	Value       AttributeType `json:"attribute_type"`                 // The actual value of the attribute (e.g., "Red", "Large")
	domain.BaseModel
}
