...
type Product struct {
	...
	Name                  string  `json:"name" db:"name"`                                       // Name of the product
	SKU                   string  `json:"sku" db:"sku"`                                         // Stock Keeping Unit, unique code for inventory tracking
	Description           string  `json:"description" db:"description"`                         // Detailed description of the product
	Price                 float32 `json:"price" dv:"price"`                                     // Price of the product
