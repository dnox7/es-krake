...
type PlatformAccount struct {
	...
	RoleID       string  `gorm:"column:role_id;type:bigint;not null" json:"role_id"`
	DepartmentID string  `gorm:"column:department_id;type:bigint;not null" json:"department_id"`
