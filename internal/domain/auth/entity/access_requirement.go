...
type AccessRequirement struct {
	...
	Operations []AccessOperation `gorm:"many2many:access_requirement_access_operations;joinForeignKey:access_requirement_id;joinReferences:access_operation_id"`
	model.BaseModel
}
